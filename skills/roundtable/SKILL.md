---
name: roundtable
description: 邀请与议题相关、有一定知名度的真实人物，模拟以求真为目标的圆桌讨论，通过即时交锋、逐轮追问和 ASCII 思考框架深入探索议题。
...
文中的“典型代表人物”默认指历史上或现实中真实存在、在相关领域有一定知名度，且其思想、研究或实践与议题有关的人物。
除非用户明确要求，不使用虚构人物、自创专家或只有职业标签的角色。
